...
public:
    ...
    class cqe_iterator {
    public:
        explicit cqe_iterator(const ::io_uring*  io_uring,
    ...
    void submit_multishot_accept_request(sqe_data*  sqe_data,
                                         int        raw_file_descriptor,
                                         sockaddr*  client_addr,
                                         socklen_t* client_len);

    void submit_recv_request(sqe_data* sqe_data, int raw_file_descriptor,
                             size_t length);

    void submit_send_request(sqe_data* sqe_data, int raw_file_descriptor,
                             const std::span<char>& buffer, size_t length);

    void submit_splice_request(sqe_data* sqe_data, int raw_file_descriptor_in,
    ...
    void add_buffer(io_uring_buf_ring* buffer_ring, std::span<char> buffer,
