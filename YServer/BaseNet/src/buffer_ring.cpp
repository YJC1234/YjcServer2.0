...
auto buffer_ring::register_buffer_ring(const unsigned int buffer_ring_size,
                                       const size_t       buffer_size) -> void {
    ...
    io_uring::get_instance().setup_buffer_ring(buffer_ring_.get(), buffer_list_,
                                               buffer_list_.size());
}
...
auto buffer_ring::return_buffer(const unsigned int buffer_id) -> void {
    ...
    io_uring::get_instance().add_buffer(buffer_ring_.get(),
                                        buffer_list_[buffer_id], buffer_id,
                                        buffer_list_.size());
}
}  // namespace YServer